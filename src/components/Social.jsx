  ...
  return (
    <section className="social-section" id="social">
      ...
      <p className="social-intro">
        Resta aggiornato con i nostri contenuti esclusivi! Scopri eventi, consigli di allenamento e ricette salutari.
      </p>
      ...
      <div className="social-content">
        ...
        <div className="social-card instagram-card">
          ...
          <div className="instagram-embed">
            {/* Sostituisci l'URL con il link del tuo ultimo post Instagram */}
            <blockquote
